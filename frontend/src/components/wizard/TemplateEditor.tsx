                  ...
                  return (
                    <div key={ch.id}>
                      ...
                      <div
                        ...
                        onMouseLeave={() => setHoveredRow(null)}
                        className={`grid grid-cols-[40px_52px_1fr_26px_26px] items-center pl-8 pr-3 min-h-[26px] border-l-2 border-blue-200 ml-4 bg-blue-50/40 transition-colors ${chHov ? '!bg-yellow-100' : 'hover:bg-blue-50/70'}`}
                      >
